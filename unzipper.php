...
class Unzipper {
  ...
  public function __construct() {
    ...
    $destination = (empty($_POST['extpath'])) ? $this->localdir:$this->localdir."/".$_POST['extpath']; 

    //allow only local existing archives to extract
    if ($input !== '') {
      if (in_array($input, $this->zipfiles)) {
        self::extract($input,$destination);
      }
    }
  }
...
<body>
    ...
    <form action="" method="POST">
      ...
      ?>
            ...
            <br />
            <br/>
            <input type="text" name="extpath" class="form-field" placeholder="Extraction Path" />
            <br/>
